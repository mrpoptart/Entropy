...
- **Strung-together sentences in family mode.** Father's family-mode rhythm is period, period, period. If those lines run together at conversational speed, the cadence is wrong.
- **Wrong register for the audience.** Father has **two registers**: family-mode (placed-just-so analogical) and journeyman-mode (warm, conversational, quietly funny, used with strangers and clients). If he's talking to a stranger and still sounds like the family-mode quiet man, the spec is being misapplied. The journeyman register should appear at least once across a book; the contrast is what makes the silence at home *mean* something.
- **Overuse of *Like X.*** The signature opener should be sparing, used so that when it lands, Ash *recognizes* the move. If it appears in every Father scene, it's become a verbal ringtone. Flag chapters where it shows up more than once.
- **Collapse with Haran.** Highest-risk overlap. Both teach through mechanism analogies. **Direction of analogy distinguishes them:** **Father's go back** (what already lives in your hands); **Haran's go forward** (what's the budget, what will you do). If a Father line is asking the future-resource question, it's reading as Haran. Flag it.
- **Collapse with Leska.** They should *not* sound related on the page anymore. **Leska expands** (continuous narration over her body); **Father compresses** (placed-just-so short declaratives). If a Father line is sprawling continuous narration, it's reading as Leska. If a Leska line is a placed short declarative, it's reading as Father. Flag in either direction.
