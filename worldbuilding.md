...
## Setting Overview
A world at a modern-equivalent level of development, built on magic rather than technology. Magic is personal and bodily — channeled through hands, voice, and intent. It is intimate, physical, and woven into every aspect of daily life. There is no magical "grid" or infrastructure that operates independently; everything depends on people channeling their personal power.

The magic is dying. It was never meant to last — not broken, not cursed, simply finite, like a geological age ending. The decline is generational, uneven, and politically contentious. The world is transitioning out of a magical era, and most of it isn't ready.

## The Nature of Magic

### The Planetary Resource
Magic is a finite planetary resource. Every person is born connected to it and draws a small personal reservoir that replenishes daily (the "pool"). This pool powers daily life — heating, healing, building, communicating, everything.

But the total planetary reservoir has been declining for generations. Each generation is born with a slightly weaker pool than the last. The decline is slow enough to debate, fast enough to measure if you're paying attention.

**Magic was always temporary.** The decline is not caused by a villain, a curse, or overuse. Magic was a finite phase of the world's existence, like a resource laid down over eons and drawn down over centuries. There is nothing to reverse and no one to blame. The only question is what comes next.

### How Magic Works (The Personal Channel)
Magic is channeled through the body — through hands, voice, breath, and focused intent. It is a physical act, more like exertion than like pressing a button. Using magic feels like something. It's effort, it's craft, it's skill.

Key properties:
- **Personal and bodily.** There are no magical devices or automated systems. Everything magical requires a person actively channeling.
- **Skill-based.** Raw power matters, but technique and practice determine how efficiently and precisely you can channel. A skilled person with a weak pool can outperform a sloppy person with a stronger one — within limits.
- **Exhaustible daily.** Each person's pool replenishes overnight, but if you spend it all by noon, you're done until tomorrow. Managing your daily reserve is a basic life skill.
- **Intimate.** Healing someone means placing your hands on them and pouring your energy into their body. Warming a room means standing in it and channeling heat. Magic is not abstract — it's relational and present.

### What Daily Magic Looks Like
*(Working sketches — to be refined)*

**Heating & Shelter:** People warm their homes by channeling — standing in a room and radiating heat, or warming stones/walls that hold the energy for a while. Architecture is designed to retain channeled warmth. In colder seasons, heating is a daily chore, like stoking a fire but with your body.
...
**Construction & Maintenance:** Buildings are raised and maintained through channeling. Grand structures from the height of the magical age require significant ongoing channeling to remain stable — built assuming a level of capacity that is no longer guaranteed.

**Agriculture:** Crops are grown with channeled encouragement — accelerated growth, pest resistance, soil enrichment. Labor-intensive and tied to the farmer's personal pool. As pools weaken, yields drop.

**The key insight for the reader:** Everything in this world depends on individual people choosing to spend their personal energy. There is no passive infrastructure. When people's pools weaken, everything weakens.

### The Generational Power Gap
Older people were born when the planetary reservoir was fuller. Their pools are measurably stronger than their children's, and dramatically stronger than their grandchildren's. This isn't subtle — it's quantifiable and visible.

**This creates a structural power imbalance:**
- Older generations hold disproportionate economic, political, and social power because they are literally more magically capable
- Institutions, infrastructure, and social expectations were built by and for people with stronger pools
- Younger people inherit systems that demand more magical capacity than they have, and are told their struggles are personal failures rather than systemic decline
- The elderly establishment has deep incentives to deny or minimize the decline, because acknowledging it threatens the systems that keep them in power

**This IS generational wealth, made visible and physical.** An elder's stronger pool isn't earned — it's an accident of birth timing. But the entire social order is built on the assumption that it's natural and right.

### The Decline as Climate Change
The magical decline maps to climate change in its social dynamics:

**Uneven impact.** Wealthy urban centers and powerful elders still have enough capacity to maintain comfortable lives. They can afford denial. Poor, rural, and young communities are already in crisis — daily magic isn't enough to maintain the systems they depend on.

**Generational divide.** Older people remember when magic was stronger and resent the decline. Younger people have never known anything else — some are angry, some are adapting, some are nihilistic.

**Political factions:**
- *Denialists:* The decline is exaggerated or cyclical. No action needed.
- *Preservationists:* Ration and regulate magic use to slow the decline. Often authoritarian in practice.
- *Accelerationists:* If magic is ending, spend it all now — one last golden age.
- *Technologists:* Build non-magical alternatives. Seen as either visionaries or traitors.
- *Authoritarians:* Centralize remaining magic under state control for "optimal allocation."
...
- **When empty, empty.** A depleted Wellspring has nothing — not even the ordinary pool. Back to zero.
...
Ash was born with this dormant reservoir instead of a pool. In a world where basic magic is as normal as breathing, he was effectively disabled — the irony being that his "disability" was caused by having more magical potential than anyone in history, sealed and inaccessible.
...
- When the reservoir empties, he returns to zero — not to the baseline pool, but to nothing
...
- *Elder districts (First through Third Terraces):* Maintained by residents with strong pools. Buildings gleam. Infrastructure works. Life feels normal. The powerful live here and see no crisis.
...
- Elder landowners still produce well and dominate the agricultural economy. When they die, their farms often collapse within a season — no one left with enough pool to maintain the output.
...
- Mining requires significant channeling for safety (reinforcing shafts, moving rock, managing air flow) — as pools weaken, mines become dangerous, then impossible

**The community that "goes dark" in Book Two is here.** A mining-and-farming settlement in the upper ridges where the youngest generation's pools have crossed below the survival threshold. They can't heat their homes in winter. They can't grow enough food. They can't heal the injured. The first community to fully lose functional magic — not because it's literally zero, but because what remains is too small to sustain the systems they depend on.
...
- **Communication across distance:** Resonance objects work regardless of distance (paired at creation), but they require channeling energy to use. In practice, distant communities communicate infrequently because every message costs pool. The Ashward communities that are "going dark" are also going silent — they can't afford to call for help.

**That last point is important:** The decline doesn't just weaken communities — it isolates them. As pools shrink, the radius of communication and travel contracts. Each community becomes more alone, more dependent on its own diminishing resources. The geography of decline is the geography of isolation.
...
- **The Transition (roughly 150–80 years before Book One):** The first measurable decline. Elder channelers noticed their children were weaker. Debate began — cyclical? Temporary? The first political factions formed. Institutions started recording pool measurements systematically. Denial was easy because the decline was slow and the Ancients were still alive, still powerful, still holding everything together.
...
### The Fundamental Economic Unit: The Pool

In a magic-dependent civilization, a person's daily pool IS their primary economic asset. Your pool determines what jobs you can hold, what maintenance you can contribute, what services you can access. Money exists — physical currency, trade ledgers, the usual mechanisms — but wealth and pool power are deeply entangled.
...
Mineral extraction — metals, stone, coal — using channeling for shaft reinforcement, rock-breaking, and ventilation. As pools weaken, mines become unsafe. Cave-ins increase. Ventilation fails. The Ashward's mining communities are among the first to face the choice between adapting and dying. Some shift to timber-framed mechanical mining. Many just close.

**The resonance trade:**
Paired resonance objects (the world's communication technology) must be created together by a skilled channeler. The objects themselves are inert — they need a user to channel into them — but their creation is a specialized craft. Resonance artisans are well-paid, and as communication becomes harder (weaker pools = fewer messages sent), existing pairs become more valuable. A thriving secondary market in pre-made resonance pairs drives prices up and access down.
...
2. **Pool** — your personal magical capacity (not transferable, but it determines your earning power)
3. **Access** — institutional connections, district residency, guild membership

The elder generation dominates all three. They have the money (accumulated over longer, more productive careers), the pool (born stronger), and the access (they built the institutions). This triple advantage is the economic engine of generational inequality — and it's the material basis for the Levelers' arguments in Book Two.

**Debt and dependency:** People without adequate pools for their district's maintenance obligations sometimes pay others to cover their share — creating a class of pool-debtors, disproportionately young, who owe a portion of their already-thin daily budget to more powerful neighbors. This is one of the quiet cruelties Ash experienced before activation.
...
- **Elder wardens are effective.** They have the pool to restrain, pursue, and overpower.
...
**Criminal law** follows standard patterns — courts, advocates, judges — but sentencing can include channeling-based penalties: forced labor on maintenance crews, pool-monitoring (a humiliating surveillance), or district exile. The system assumes magic makes enforcement possible. The decline is eroding that assumption.

**Military structure** exists at the national level but matters little for the trilogy's scope. Solathis maintains a ceremonial guard and contributes channelers to national defense obligations. The last significant military conflict was generations ago. The military is an institution in decay, its relevance fading with the pool — which means the nation's ability to respond to external threats is declining alongside everything else.
...
**Preservationists:** The political center. Ration magic use, regulate waste, extend the timeline. Preservationist policy sounds reasonable and is often authoritarian in practice — rationing means someone decides who gets how much, and that someone is usually an elder with a comfortable pool. Ash encounters preservationist logic in Book Two when the Levelers demand redistribution: the establishment's counter-argument is always "managed decline," which means managed by the people at the top.
...
After the shift, she has 600-700 kJ left for the day. She works a second job — packing goods at a trade warehouse, physical labor that doesn't require channeling. The pay is worse but it doesn't drain her pool. She eats lunch at the warehouse: a bowl of something warm from a communal pot, heated by an older worker whose pool can afford it.

Evening. She walks home past an elder district where the streetlamps still glow with channeled light. Her own street is dark — nobody has the pool to waste on lighting. She heats a bowl of soup with her hands (84 kJ), sits in the half-dark, and thinks about tomorrow.
...
He wakes in his parents' home. The walls are warm — his mother channels the house every morning, spending a significant portion of her daily pool to make sure he's comfortable. He knows the cost. He pretends he doesn't.
...
Walking to work — to Dorenne's office where he's an aide — he takes streets, not transit. The channeler-powered tram costs a small pool contribution from each rider, a social courtesy he can't pay. He walks past people channeling casually: warming their cloaks, flicking small objects to their hands, greeting each other with a brief resonance touch. Every gesture is a reminder.
