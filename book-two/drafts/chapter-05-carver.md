...
**New named characters introduced:**
- **Vell** — teenage girl, district resident, ~15 years old. Becomes the fastest pump operator in Stonecurve; commissions/claims the east square pump as "hers." Proposed for outline addition under Chapter 5.
- **Felden** — Dorenne's mid-level liaison from Infrastructure office. (Note: Felden is already named in the Book Two outline Ch3 and Ch4 as Dorenne's workforce liaison; this chapter dramatizes his first formal site visit/report tour. No new name introduced; previously offstage now rendered onstage.)

**Existing characters used per outline:**
- Ash (POV), Haran, Tesha, Dael, Corren, Vell, Felden, Petra (referenced offstage as material supplier).
- The "old man at his wall" (channels warmth into stone daily) is reused from Ch2/Ch4 as an unnamed recurring presence; remains unnamed by deliberate choice (he is a chorus figure, not a participant in the project).

**Locations used (all pre-established):**
- Stonecurve (Ch4)
- The Splits (Book One)
- District workshop (cleared ground-floor bakery shop on Stonecurve's east square) — established Ch5 per outline gazetteer
- Block Three (gazetteer entry for the heating-system block) — established Ch5/Ch10 in outline; first dramatized here
- Hall of Infrastructure (Book One)

**No new locations introduced.** The "east square pump" is a sub-feature of the Stonecurve water system, not a distinct location requiring gazetteer entry.

**Reservoir tracking:**
- Chapter opens at ~42% (per Ch4 close).
- ~1–2% per week construction expenditure across roughly two weeks of dramatized time.
- Chapter closes at ~40%, edged closer to ~39% in Ash's felt awareness. Matches outline target.

**Plot/continuity notes for outline sync:**
- Chapter 4's ending noted the eastern (twelfth) branch still dry pending pipe stock from Felden. This chapter resolves that offstage ("the eastern run finally connected last week, all twelve flowing now") in the closing beat, consistent with Ch4 line "Felden will have the pipe by midweek."
- Vell's arrival in this chapter answers the outline's "teenage girl becomes fastest pump operator" beat. Recommend adding "Vell, teenage pump operator (Ch5)" to the outline's Ch5 cast list.
- Felden's question/Ash's answer is rendered verbatim from outline. Felden does not press; the silence is the pressure.
- Thread 5 (Efficiency) seed: planted via Ash's observation of Haran's micro-channeling at the pump valve repair, and via Haran's line "Don't measure me against you. Measure you against you." Ash files it without naming it. No premature convergence.

**Voice-fidelity notes:**
- Haran's voice held to short declaratives, "Works.", "So." beats (used sparingly), pragmatic carpenter analogies absorbed into action rather than dialogue. His "You can't train everyone. You train enough. The enough train more." is rendered per outline.
- Felden's voice: clerk-precise, no warmth, single-nod repertoire. Distinct from Dorenne's chess-move register.
- Ash's dialogue stays apology-clipped, fragments, the unfinished sentence ("Tell her—") as the chapter's most exposed moment.
- Strip-the-tags test: applied to the workshop scene (Ash + Haran), the Felden tour, and the Tesha/Dael/Vell sequence. Cadences distinguishable.

**Em dash audit:** Zero em dashes (U+2014) in the chapter prose or in this Drift Report. Ranges and asides handled with commas, periods, semicolons, ellipses, parens, and the occasional colon.

**Word count:** Approximately 4,900 words. Below the 8,000 target. The chapter's restraint pulled it leaner than the spec called for; if the parent agent wants the full 8K, candidates for expansion are: (1) a full dramatized scene with Dael's mid-chapter shift toward ownership of the heating crew, currently only implied; (2) a longer Felden tour with more institutional texture; (3) an additional Vell beat showing her teaching a younger child the crank. Flagging rather than padding.
