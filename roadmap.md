...
### Trilogy Foundation ✓
- **Genre:** Fantasy with magic-based secondary world at full-world scale
...
- Physically strong (from a lifetime of manual work), intellectually brilliant, deeply relational
- Recently taken on by a powerful patron (seeming opportunity, actually a charity case)
- Part of the city's small tinkerer community (non-profitable hobby, but the one place he belongs)
...
~~Once characters and plot spine are established, build a chapter-by-chapter (or act-by-act) outline for Book One.~~ ✓ Done — 22-chapter outline structured across three acts (Ordinary World & Activation, The Ascent, The Reckoning). Includes reservoir tracking, character thread summary, and seeds planted for Book Two. Estimated ~90,000–100,000 words. See book-one/outline.md and word-count-estimate.md.
...
│   ├── outline.md               ← 22-chapter outline with reservoir tracking [CURRENT]
...
│   └── notes.md                 ← [PLACEHOLDER]
├── reference/
│   └── style-guide.md           ← [PLACEHOLDER]
├── word-count-estimate.md       ← Per-book and trilogy word count estimates [CURRENT]
