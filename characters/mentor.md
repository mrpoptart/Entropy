...
## His Relationship with the Protagonist

### Before the Wellspring
The protagonist found the workshop the way most tinkerers do — drawn by curiosity and the need for a place where his condition wasn't the most interesting thing about him. In the workshop, what matters is whether you can solve the problem in front of you. The protagonist can. He's been solving physical problems with his hands and his mind his entire life.

The mentor recognized something in the protagonist immediately: a mind that works the way his does. Someone who understands systems, who thinks about *why* before *how*, who sees the elegant solution hiding inside the obvious one. The protagonist's lack of magic, which the rest of the world treats as a disability, is invisible in the workshop. What's visible is the intelligence and the work ethic.

Their relationship is built on shared work. They don't have emotional heart-to-hearts — they have long afternoons of building things together, punctuated by the mentor's sideways observations about how the world works. The protagonist absorbs the mentor's way of thinking without realizing it's happening: resource management, long-term planning, building systems that don't depend on any single person, designing for failure.

The mentor cares deeply about the protagonist but expresses it through attention and time, not words. He gives the protagonist harder problems. He trusts him with better tools. He makes space at the workbench without being asked. In a world that treats the protagonist as a burden, the mentor treats him as a colleague.
...
He doesn't celebrate. He doesn't mourn. He asks the protagonist how it feels and then asks how much there is.

**He is the first person to treat the Wellspring as what it actually is: a resource management problem.** Not a miracle, not a curse, not an identity — a finite reservoir that requires strategy. This is jarring for the protagonist, who wants someone to share the wonder with, and grounding, because it's the first honest response he gets.

As the protagonist drifts from the workshop — intoxicated by power, pulled into the patron's orbit, busy being extraordinary — the mentor doesn't chase him. He doesn't lecture or guilt-trip. He keeps the workbench clear. He continues the work. He is there when the protagonist comes back, and he treats the return as unremarkable, because to him it was inevitable.

When the protagonist finally does the math and realizes the reservoir is finite, the mentor is the person he goes to. Not because the mentor has answers about magic — he doesn't — but because the mentor is the person who has spent thirty years thinking about what you do when the resource runs out.

## His Role Across the Trilogy

### Book One
A warm, grounding presence in the first act — the workshop scenes establish him and the tinkerer community as the protagonist's real home. When the Wellspring activates, he provides the first honest perspective. As the protagonist drifts away, the mentor's absence from the narrative mirrors the protagonist's drift from his own foundations.

He returns to importance late in the book, when the protagonist confronts the reservoir's finitude. The mentor doesn't say "I told you so." He says something like: *"So. How much is left, and what do you want to build with it?"*

### Book Two
The tinkerer community and the mentor become more relevant as the world's decline accelerates. The protagonist, having learned that raw power can't force lasting change, begins to see what the mentor has been building all along — not just machines, but a *framework* for living without magic. The workshop isn't a hobby. It's a prototype for the future.

The mentor may serve as a bridge between the protagonist and the emerging technologist movement — the people building non-magical alternatives out of necessity in the poorer districts and rural communities. He's been quietly connected to these networks for decades.

### Book Three
The mentor's decades of preparation bear fruit. The systems and knowledge he's been building become part of the foundation the protagonist is trying to create for the post-magic world. The mentor is vindicated — not triumphantly, but quietly. The world is finally arriving at the conclusion he reached thirty years ago.

Whether the mentor lives to see the full transition or passes before it's complete is an open question. If he dies, it should be unremarkable — old age, a life fully lived, the work continuing without him. If he lives, the epilogue might show the protagonist working beside him again, at the same workbench, building something with their hands.
